    ...
    <tr>
        ...
        <c:forEach var="bookmark" items="${bookmarks}">
            ...
            <td><div align="center"><c:out  value="${bookmark.id}"/>
                ...
                <td><div align="center"><a href="/ManageBookmarks/delete?bid=${bookmark.id}">
                    delete</a>&nbsp|&nbsp
                    <a href="/ManageBookmarks/edit?bid=${bookmark.id}">edit</a>
                </div></td>
...
<hr>
<a href="/ManageBookmarks/add">Add new bookmark</a>
